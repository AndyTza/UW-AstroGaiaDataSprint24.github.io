...
<div style="background-color: #f5f0ff; padding: 15px; border-radius: 10px; margin-bottom: 20px; max-width: 1000px; text-align: center;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(150px, 1fr)); gap: 20px; align-items: center; justify-content: center; overflow-x: auto;">
        <div style="background-color: #e5dbff; padding: 10px; border-radius: 8px; white-space: normal; overflow: hidden;">
